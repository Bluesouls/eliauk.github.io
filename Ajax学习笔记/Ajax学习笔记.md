...
![image-20220423152358667](Ajax学习笔记.assets/image-20220423152358667.png)
...
![image-20220423153450319](Ajax学习笔记.assets/image-20220423153450319.png)

## 三、客户端与服务器的通信过程

### 3.1、图解客户端与服务器的通信过程

![image-20220423154046508](Ajax学习笔记.assets/image-20220423154046508.png)
...
![image-20220423155823475](Ajax学习笔记.assets/image-20220423155823475.png)
...
![image-20220423163111446](Ajax学习笔记.assets/image-20220423163111446.png)

搜索提示：当输入搜索关键字时，通过 ajax 的形式，动态加载搜索提示列表

![image-20220423163132940](Ajax学习笔记.assets/image-20220423163132940.png)

数据分页显示：当点击页码值的时候，通过 ajax 的形式，根据页码值动态刷新表格的数据

![image-20220423163202243](Ajax学习笔记.assets/image-20220423163202243.png)

数据的增删改查：数据的添加、删除、修改、查询操作，都需要通过 ajax 的形式，来实现数据的交互

![image-20220423163257355](Ajax学习笔记.assets/image-20220423163257355.png)
...
- **通过 GET 方式请求接口的过程**
  ...
  ![image-20220426081114291](Ajax学习笔记.assets/image-20220426081114291.png)

- **通过 POST 方式请求接口的过程**

  ![image-20220426081205072](Ajax学习笔记.assets/image-20220426081205072.png)
...
![image-20220426082517536](Ajax学习笔记.assets/image-20220426082517536.png)
...
![image-20220426082613310](Ajax学习笔记.assets/image-20220426082613310.png)
...
![image-20220426083153346](Ajax学习笔记.assets/image-20220426083153346.png)

![image-20220426083203295](Ajax学习笔记.assets/image-20220426083203295.png)

![image-20220426083213704](Ajax学习笔记.assets/image-20220426083213704.png)