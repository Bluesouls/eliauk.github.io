...
![image-20220412091831461](image-20220412091831461.png)
...
![image-20220412093109596](image-20220412093109596.png)
...
### ![image-20220412123416194](image-20220412123416194.png)6.3.8、destroyed() 生命周期函数
...
![image-20220412123620004](image-20220412123620004.png)
...
![image-20220418191433317](image-20220418191433317.png)

axios 封装的6个属性：

![axios 封装的 6 个属性](axios 封装的 6 个属性.png)
...
![image-20220409181040825](image-20220409181040825.png)
...
![image-20220409183006003](image-20220409183006003.png)
...
<img src="image-20220323210516595.png" alt="image-20220323210516595" style="zoom:50%;" />
...
<img src="image-20220323210916204.png" alt="image-20220323210916204" style="zoom: 80%;" />
...
![05d401d4852fb1a8d5136c3c722827be.png](05d401d4852fb1a8d5136c3c722827be.png)
...
<img src="image-20220323212839860.png" alt="image-20220323212839860" style="zoom:80%;" />
...
<img src="image-20220323213654869.png" alt="image-20220323213654869" style="zoom:67%;" />

数据发生变化时触发 `usename` 的监听事件，先模拟接口提示验证信息，在两秒后调用一次 `checkName()` 方法进行验证。

<img src="image-20220323214434857.png" alt="image-20220323214434857" style="zoom:67%;" />
...
![image-20220415192841220](image-20220415192841220.png)
...
- 示例:
  ...
  <img src="image-20220323213415538.png" alt="image-20220323213415538" style="zoom:80%;" />
...
- **immediate** **选项**
  ...
  ![image-20220415194120924](image-20220415194120924.png)
...
<img src="image-20220323224147011.png" alt="image-20220323224147011" style="zoom:67%;" />
...
![461afcb940922444efca074b6e4a7841.png](461afcb940922444efca074b6e4a7841.png)
...
![10c1970be45960f24799dc32a8f783b4.png](10c1970be45960f24799dc32a8f783b4.png)
...
![5f4c94d19107d70771f295600c5cba76.png](5f4c94d19107d70771f295600c5cba76.png)
...
![95ac3f86e6fc6cba1c528ec28d86ad15.png](95ac3f86e6fc6cba1c528ec28d86ad15.png)
...
- 前端路由监听到了 Hash 地址的变化
  ...
  - 前端路由把当前 Hash 地址对应的组件渲染到浏览器中
    ...
    ![image-20220416122605954](image-20220416122605954.png)
...
- 步骤3：在 created 生命周期函数中，监听浏览器地址栏中 hash 地址的变化，动态切换要展示的组件的名称：
  ...
  ![image-20220404172923071](C:\Users\Struglen\AppData\Roaming\Typora\typora-user-images\image-20220404172923071.png)

  补充：普通函数和箭头函数的区别

  **1、箭头函数是匿名函数，不能作为构造函数，不能使用new，普通函数可以作为构造函数，使用new。**

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516210043658-294763669.png" alt="img" style="zoom:50%;" />

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516210137476-1736717570.png" alt="img" style="zoom: 67%;" />

   **2、箭头函数捕获上下文中的this作为自己的this，普通函数指向调用它的对象**

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516210729026-1246346213.png" alt="img" style="zoom: 50%;" />

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516210818268-1826983901.png" alt="img" style="zoom: 50%;" />

  3、箭头函数采用rest参数传递实参，普通函数采用arguments解决实参传递

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516211230068-1856737244.png" alt="img" style="zoom: 67%;" />

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516211230068-1856737244.png" alt="img" style="zoom: 67%;" />

   4、箭头函数没有原型属性

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516211713532-331608545.png" alt="img" style="zoom:67%;" />

  <img src="https://img2020.cnblogs.com/blog/2327410/202105/2327410-20210516211641875-1540223280.png" alt="img" style="zoom: 67%;" />
...
<img src="image-20220419082734367.png" alt="image-20220419082734367" style="zoom:67%;" />
...
<img src="image-20220419083101540.png" alt="image-20220419083101540" style="zoom:50%;" />
...
- 可以使用 this.$route.params 对象访问到动态匹配的参数值。
  ...
  ![image-20220419213315779](image-20220419213315779.png)
  ...
  <router-link to="/movie/3">复联</router-link>
  ```
  ![image-20220420133057451](image-20220420133057451.png)
...
![image-20220420141110600](image-20220420141110600.png)

会增加一条历史记录

![image-20220420140820569](image-20220420140820569.png)
...
![image-20220420141017438](image-20220420141017438.png)
...
![image-20220420144849089](image-20220420144849089.png)
...
![image-20220420145544310](image-20220420145544310.png)
...
![image-20220420145904779](image-20220420145904779.png)

此时无 token 值

<img src="image-20220420150113211.png" alt="image-20220420150113211" style="zoom:50%;" />

强制跳转到 /login 登录页

![image-20220420150157525](image-20220420150157525.png)
...
<img src="image-20220420150412075.png" alt="image-20220420150412075" style="zoom:50%;" />
...
![1f2dd436d89d8d0ad53d5c4bde7f31d6.png](1f2dd436d89d8d0ad53d5c4bde7f31d6.png)
...
![276a18263f374640db39d5a5b7bcb544.png](276a18263f374640db39d5a5b7bcb544.png)
...
![5713fe270dee777307f05236c4f1bdea.png](5713fe270dee777307f05236c4f1bdea.png)
...
![9f6e5d793eec9febf6c27c71c8540dc8.png](9f6e5d793eec9febf6c27c71c8540dc8.png)
...
![a303effe000076ca752dae571d042a71.png](a303effe000076ca752dae571d042a71.png)
